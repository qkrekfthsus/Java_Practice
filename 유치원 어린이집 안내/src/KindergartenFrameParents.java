...
public class KindergartenFrameParents extends JFrame implements ActionListener {
	static String sqlSelectAll = "select name, tel,address,publicprivate,Facilitytype from kindergarten;";
	static String sqlSearch = "select name, tel,address,publicprivate,Facilitytype from kindergarten where name = ? AND tel=?;";
