...
public class BoxLayoutTest extends JFrame { 
	public BoxLayoutTest() { 
		...
		hhBox.add(Box.createHorizontalStrut(30));    hhBox.add(new JCheckBox("국민은행")); 
		hhBox.add(Box.createHorizontalStrut(30));  hhBox.add(new JCheckBox("외환은행")); 
		hhBox.add(Box.createHorizontalStrut(30));    hhBox.add(new JCheckBox("기업은행")); 
