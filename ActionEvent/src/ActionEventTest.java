...
ActionEventTest() { 
	...
	jbtn1 = new JButton("입력"); 	add(jbtn1); 
	jbtn2 = new JButton("확인"); 	add(jbtn2); 
	jbtn3 = new JButton("옵션");	add(jbtn3); 
	jbtn4 = new JButton("메시지");	add(jbtn4);
	...
	if(e.getSource()== jbtn2) {
		...
		if(e.getSource()== jbtn3) {
			...
			JOptionPane.showOptionDialog(this, "원하는 잡업 선택","옵션 대화상자",
