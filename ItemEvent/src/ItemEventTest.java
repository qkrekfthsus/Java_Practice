...
public class ItemEventTest extends JFrame { 
	...
	public ItemEventTest() { 
		...
		rgroup.add(r1=new JRadioButton("우리투자증권")); 	hBox.add(r1); 
		hBox.add(Box.createHorizontalStrut(30)); 
		rgroup.add(r2=new JRadioButton("삼성증권")); 		hBox.add(r2); 
		hBox.add(Box.createHorizontalStrut(30)); 
		rgroup.add(r3=new JRadioButton("대우증권")); 		hBox.add(r3); 
		hBox.add(Box.createHorizontalStrut(30)); 
		...
		cgroup.add(r4=new JRadioButton("국민은행")); 	hhBox.add(r4); 
		hhBox.add(Box.createHorizontalStrut(30)); 
		cgroup.add(r5=new JRadioButton("외환은행")); 	hhBox.add(r5); 
		hhBox.add(Box.createHorizontalStrut(30)); 
		cgroup.add(r6=new JRadioButton("기업은행")); 	hhBox.add(r6); 
		hhBox.add(Box.createHorizontalStrut(30)); 
		...
		cBox.add(lpanel); 	cBox.add(llpanel); 
		txt1=new JLabel("증권회사 출력됨");
		txt1.setFont(new Font("굴림", Font.PLAIN, 16)); 	cBox.add(txt1); 
		txt2=new JLabel("은행 출력됨"); 
		txt2.setFont(new Font("굴림", Font.PLAIN, 16)); 
		cBox.add(txt2); 		add(cBox); 
		RBHandler rh=new RBHandler();
		r1.addItemListener(rh);			r2.addItemListener(rh); 
		r3.addItemListener(rh); 		r4.addItemListener(rh); 
		r5.addItemListener(rh); 		r6.addItemListener(rh); 	} 
